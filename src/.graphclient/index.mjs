...
import * as importedModule$0 from "./sources/uniswapv2/introspectionSchema.json";
            ...
            return [
                {
                    ...
                    get rawSDL() {
                        return printWithCache(GetQueryDocument);
                    },
...
export function getSdk(requester) {
    return {
        GetQuery(variables, options) {
            return requester(GetQueryDocument, variables, options);
        }
    };
}
